...
component: "Tab"
description: "This example demonstrates how to customize the scroll step of Essential JS 2 Tab Control"
---
...
{% tab template="tab/scrollstep", sourceFiles="app/**/*.ts,index.css"%}
