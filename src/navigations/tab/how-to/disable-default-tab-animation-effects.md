---
title: "Disable default Tab animation effects"
component: "Tab"
description: "This example demonstrates how to disable the default animations of the Essential JS 2 Tab control."
---

# Disable default Tab animation effects

You can disable the default Tab animations with the help of the [`animation`](../../api/tab#animation) property of the Tab.
...
{% tab template="tab/disable-animation", sourceFiles="app/**/*.ts,index.css"%}
