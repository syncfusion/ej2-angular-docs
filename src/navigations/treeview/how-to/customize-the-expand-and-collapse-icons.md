...
{% tab template="tree-view/getting-started", sourceFiles="app/**/*.ts,index.css"  %}
...
@Component({
    ...
    template: `<div id='treeparent'><ejs-treeview id='treeelement' [fields]='field' [cssClass]='cssClass'></ejs-treeview></div>`
})
