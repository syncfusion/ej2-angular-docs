...
{% tab template="document-editor/getting-started",isDefaultActive=false, sourceFiles="app/**/*.ts" %}
...
@Component({
  ...
  template: `
    <ejs-documenteditor #documenteditor_readonly style="width:100%;height:100%;display:block" (created)="onCreate()" (documentChange)="onDocumentChange()"  [isReadOnly]=false [enableEditor]=true ></ejs-documenteditor>
  `,
...
@Component({
    selector: 'app-container',
    template: `<ejs-documenteditorcontainer #documenteditor_readonly [enableToolbar]=true (created)="onCreate()" (documentChange)="onDocumentChange()" ></ejs-documenteditorcontainer>`,
    encapsulation: ViewEncapsulation.None,
