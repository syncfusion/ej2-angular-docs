...
@Component({
  ...
  template: `
    <ejs-documenteditor #documenteditor style="width:100%;height:100%;display:block" (created)="onCreate()"></ejs-documenteditor>
  `,
...
@Component({
    selector: 'app-container',
    template: `<ejs-documenteditorcontainer #documenteditor_default [enableToolbar]=true (created)="onCreate()"></ejs-documenteditorcontainer>`,
    encapsulation: ViewEncapsulation.None,
