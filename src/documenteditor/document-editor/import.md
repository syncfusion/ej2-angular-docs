...
description: "Learn how to import SFDT and word documents in Angular document editor using supported APIs."
---
...
```csharp
  ...
  public string Import(IFormCollection data)
  {
        ...
        file.CopyTo(stream);
        stream.Position = 0;
        //Convert the input file into sfdt.
        WordDocument document = WordDocument.Load(stream, GetFormatType(type.ToLower()));
        string sfdt = Newtonsoft.Json.JsonConvert.SerializeObject(document);
        document.Dispose();
        return sdft;
  }
  //Get input file's format type.
