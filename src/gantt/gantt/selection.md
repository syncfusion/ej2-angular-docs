...
To select data, inject the [`SelectionService`](../api/gantt/#selectionmodule) module in provider section of `AppModule`.
...
{% tab template="gantt/selection/bothcellrow",sourceFiles="app/**/*.ts" %}
...
@Component({
    selector: 'app-root',
    template:
       `<ejs-gantt id="ganttDefault" height="430px" [dataSource]="data" [taskFields]="taskSettings" [selectionSettings]="selectionSettings"></ejs-gantt>`,
...
{% tab template="gantt/selection/disableselect",sourceFiles="app/**/*.ts" %}
...
@Component({
    selector: 'app-root',
    template:
       `<ejs-gantt id="ganttDefault" height="430px" [dataSource]="data" [taskFields]="taskSettings" [allowSelection]='false'></ejs-gantt>`,
    encapsulation: ViewEncapsulation.None
})
export class AppComponent{
    // Data for Gantt
...
{% tab template="gantt/selection/selectrow-initial",sourceFiles="app/**/*.ts" %}
...
@Component({
    selector: 'app-root',
    template:
       `<ejs-gantt id="ganttDefault" height="430px" [dataSource]="data" [taskFields]="taskSettings" [selectedRowIndex] = '5'></ejs-gantt>`,
    encapsulation: ViewEncapsulation.None
})
export class AppComponent{
    // Data for Gantt
...
{% tab template="gantt/selection/selectrow-dynamic",sourceFiles="app/**/*.ts" %}
...
{% tab template="gantt/selection/multiplerow",sourceFiles="app/**/*.ts" %}
...
{% tab template="gantt/selection/multiplerow-dynamic",sourceFiles="app/**/*.ts" %}
...
@Component({
    selector: 'app-root',
    template:
       `<button ejs-button id='selectMultipleRow' (click)='select()'>Select Multiple Row</button>
        <br><br>
...
{% tab template="gantt/selection/customize-rowselection",sourceFiles="app/**/*.ts" %}
...
@Component({
    selector: 'app-root',
    template:
       `<ejs-gantt id="ganttDefault" height="430px" [dataSource]="data" [taskFields]="taskSettings" [selectionSettings]="selectionSettings" (rowSelecting)="rowSelecting($event)"></ejs-gantt>`,
    encapsulation: ViewEncapsulation.None
})
export class AppComponent{
    // Data for Gantt
...
{% tab template="gantt/selection/cell",sourceFiles="app/**/*.ts" %}
...
{% tab template="gantt/selection/multiplecell",sourceFiles="app/**/*.ts" %}
...
{% tab template="gantt/selection/selectcell-dynamic",sourceFiles="app/**/*.ts" %}
...
export class AppComponent{
    ...
    select(): void {
        this.ganttObj.selectionModule.selectCell({ cellIndex: 1, rowIndex: 1 });
        };
}
```
...
{% tab template="gantt/selection/customize-cellselection",sourceFiles="app/**/*.ts" %}
...
@Component({
    selector: 'app-root',
    template:
       `<ejs-gantt id="ganttDefault" height="430px" [dataSource]="data" [taskFields]="taskSettings" [selectionSettings]="selectionSettings" (cellSelecting)="cellSelecting($event)"></ejs-gantt>`,
    encapsulation: ViewEncapsulation.None
})
export class AppComponent{
    // Data for Gantt
...
{% tab template="gantt/selection/toggleselection",sourceFiles="app/**/*.ts" %}
...
{% tab template="gantt/selection/clearselection",sourceFiles="app/**/*.ts" %}
...
{% tab template="gantt/selection/rowIndex",sourceFiles="app/**/*.ts" %}
...
{% tab template="gantt/selection/multipleSelection",sourceFiles="app/**/*.ts" %}
