...
{% tab template="diagram/shapes/text", sourceFiles="app/**/*.ts", isDefaultActive=true %}
...
{% tab template="diagram/shapes/image", sourceFiles="app/**/*.ts", isDefaultActive=true %}
...
{% tab template="diagram/shapes/alignment", sourceFiles="app/**/*.ts", isDefaultActive=true %}
...
{% tab template="diagram/shapes/native", sourceFiles="app/**/*.ts", isDefaultActive=true %}

```typescript
import { Component, ViewEncapsulation, ViewChild } from '@angular/core';
import { Diagram, NodeModel, NativeModel , TextStyleModel } from '@syncfusion/ej2-diagrams';
import { DiagramComponent } from '@syncfusion/ej2-angular-diagrams';
...
{% tab template="diagram/shapes/basic", sourceFiles="app/**/*.ts", isDefaultActive=true %}
...
{% tab template="diagram/shapes/path", sourceFiles="app/**/*.ts", isDefaultActive=true %}
